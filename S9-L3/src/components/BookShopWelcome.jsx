    ...
    <>
      <Container fluid={true} className="bg-primary pb-4">
        ...
        <h2 className="text-white pb-5">
          Rilassati leggendo sotto la brezza marina
        </h2>
        <Alert show={show} variant="success">
          <Alert.Heading>SCONTO DI BENVENUTO!</Alert.Heading>
          <p>
            Hai uno sconto del 10% sul tuo primo acquisto e la spedizione
            gratuita se superi i 50 euro di spesa, usa il codice sconto FIRST10
            al checkout!
          </p>
          <hr />
